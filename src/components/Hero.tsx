    ...
    >
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400 mb-12 leading-relaxed animate-fade-in-delayed-2">
         I analyze and interpret complex data to build actionable insights that drive real-world impact. Specializing in data cleaning, statistical modeling, and building predictive machine learning models using modern tools and techniques.
        </p>
