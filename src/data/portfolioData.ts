...
export const projects: Project[] = [
  ...
  {
    id: 'project3',
    title: 'FitnessPal - Health Tracker',
...
export const about = {
  ...
  description: `
I'm an aspiring data scientist with a strong passion for uncovering insights and solving problems using data. My journey began with a deep curiosity about how things work, which led me to explore programming through languages like C and C++, and eventually dive into the world of data science.

I’m currently building my skills in Python, machine learning, and data visualization, working on personal projects that apply real-world datasets to practical problems.

When I’m not immersed in code, you’ll find me in the gym, exploring new places, or gaming—activities that fuel my creativity, discipline, and strategic thinking. I’m always eager to learn, grow, and take on challenges that push my limits.`,
